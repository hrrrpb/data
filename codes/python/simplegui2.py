...
secondlabel = tkinter.Label(rootwindow, text="City: ", font="Ariel 24", foreground="blue", background="light grey")
secondlabel.grid(row=1,column=0,sticky="wens")
thirdlabel = tkinter.Label(rootwindow, text="State: ", font="Ariel 24", foreground="blue", background="light grey")
thirdlabel.grid(row=2,column=0,sticky="wens")
...
submitbutton = tkinter.Button(rootwindow, height=1, text="Submit", font="Times 24", foreground="orange", background="pink", command=getweatherreport)
submitbutton.grid(row=3, column=1,sticky="wens")

outputtext = tkinter.StringVar()
outputmessage = tkinter.Message(rootwindow, textvariable=outputtext, foreground="blue", background="white", width=300, anchor="w", justify="left")
